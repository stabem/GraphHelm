# M06 dogfood run — a byte-archive of an event store
...
```sh
graphhelm execution status --events docs/acceptance/m06-run-2026-08-17/events --pretty
```

Expected: `executionId` `exec-m06-dogfood`, `headSequence` 70.
