...
RUN=C:/Users/example/AppData/Local/Temp/m08-judge4
ART=$WT/docs/acceptance/m08-rejudge-2026-08-18
PORT=42217
...
def alarm():
    ...
    try:
        armed = post("/wake-lease", {"sessionId": "operator-m07",
                                     "rendezvousId": "m07-operator"}, "m08-arm4")
...
try:
    reply = post("/start", body, "m08-judge4-start")
except urllib.error.HTTPError as error:
