...
RUN=C:/Users/example/AppData/Local/Temp/m08-judge7
ART=$WT/docs/acceptance/m08-rejudge7-2026-08-18
PORT=42225
...
def alarm():
    ...
    try:
        armed = post("/wake-lease", {"sessionId": "operator-m07",
                                     "rendezvousId": "m07-operator"}, "m08-arm7")
...
try:
    reply = post("/start", body, "m08-judge7-start")
except urllib.error.HTTPError as error:
