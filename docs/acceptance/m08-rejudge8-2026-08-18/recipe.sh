...
RUN=C:/Users/example/AppData/Local/Temp/m08-judge8
ART=$WT/docs/acceptance/m08-rejudge8-2026-08-18
PORT=42227
...
def alarm():
    ...
    try:
        armed = post("/wake-lease", {"sessionId": "operator-m07",
                                     "rendezvousId": "m07-operator"}, "m08-arm8")
...
try:
    reply = post("/start", body, "m08-judge8-start")
except urllib.error.HTTPError as error:
